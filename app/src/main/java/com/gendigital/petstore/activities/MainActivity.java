    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.mFavoritos:
                ...
                break;
            case R.id.mContacto:
                Intent ventanaCon = new Intent(this, ContactoActivity.class);
                startActivity(ventanaCon);
                break;
            case R.id.mAcerca:
                Intent ventanaAce = new Intent(this, AcercaActivity.class);
                startActivity(ventanaAce);
                break;
        }
        return true;
    }
